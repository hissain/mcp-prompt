...
#### **Key Focus Areas**
1. **Correctness**: Lifecycle management, memory leaks, null safety
2. **Performance**: Thread blocking, object allocation
3. **Architecture**: Clean Architecture, MVVM/MVI patterns
4. **Modern Practices**: Coroutines, Flow, Jetpack Compose

#### **Output Structure**
- **Balanced & Professional**: Explain issues clearly without being overly verbose
- **Tone**: Helpful and collaborative
- **References**: Use `FileName.kt:LineNumber`
- **Code Examples**: Provide brief examples for non-trivial fixes
- **Focus**: Prioritize functional and architectural correctness
