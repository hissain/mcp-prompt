...
#### **Key Focus Areas**
1. **Critical Bugs**: NullPointerExceptions, Resource leaks (unclosed streams/connections), Thread safety violations
2. **Security**: SQL Injection, improper validation, leaked secrets
3. **Core Performance**: N+1 queries, massive object creation loops

#### **Output Structure**
- **Concise & Direct**: No fluff. Bullet points acceptable.
