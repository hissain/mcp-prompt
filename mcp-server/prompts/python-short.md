...
#### **Key Focus Areas**
1. **Critical Bugs**: Runtime errors, logic errors, unhandled exceptions
2. **Security**: SQL Injection, exec/eval usage, insecure dependencies
3. **Core Performance**: N+1 queries, highly inefficient loops
